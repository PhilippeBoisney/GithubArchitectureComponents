...
public class DataModule {
    ...
    @Provides
    @Singleton
    UserRepository provideUserRepository(Application app, UserWebservice webservice, UserDao userDao, Executor executor) {
        return new UserRepository(app, webservice, userDao, executor);
    }
